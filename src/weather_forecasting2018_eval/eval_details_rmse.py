...
def _eval_result(fore_file, obs_file, anen_file):
    ...
    try:
        ...
        station_score = {'90001':{'rmse':0, 't2m_rmse':0, 'rh2m_rmse':0, 'w10m_rmse':0},
        '90002':{'rmse':0, 't2m_rmse':0, 'rh2m_rmse':0, 'w10m_rmse':0},
        '90003':{'rmse':0, 't2m_rmse':0, 'rh2m_rmse':0, 'w10m_rmse':0},
        '90004':{'rmse':0, 't2m_rmse':0, 'rh2m_rmse':0, 'w10m_rmse':0},
        '90005':{'rmse':0, 't2m_rmse':0, 'rh2m_rmse':0, 'w10m_rmse':0},
        '90006':{'rmse':0, 't2m_rmse':0, 'rh2m_rmse':0, 'w10m_rmse':0},
        '90007':{'rmse':0, 't2m_rmse':0, 'rh2m_rmse':0, 'w10m_rmse':0},
        '90008':{'rmse':0, 't2m_rmse':0, 'rh2m_rmse':0, 'w10m_rmse':0},
        '90009':{'rmse':0, 't2m_rmse':0, 'rh2m_rmse':0, 'w10m_rmse':0},
        '90010':{'rmse':0, 't2m_rmse':0, 'rh2m_rmse':0, 'w10m_rmse':0},
        'all':{'rmse':0, 't2m_rmse':0, 'rh2m_rmse':0, 'w10m_rmse':0},}
        ...
        for s in stations:
            ...
            rmse_all = (t2m_rmse1+rh2m_rmse1+w10m_rmse1) / 3
            rmse_ruitu = (t2m_rmse+ rh2m_rmse+ w10m_rmse) / 3
            # bias得分
            ...
            print('\n')
            print('Station {} RMSE: {}'.format(s, rmse_all))
            station_score[s]['rmse']=rmse_all
            station_score[s]['t2m_rmse']=t2m_rmse1
            station_score[s]['rh2m_rmse']=rh2m_rmse1
            station_score[s]['w10m_rmse']=w10m_rmse1

            print('Station {} RMSE_RUITU: {}'.format(s, rmse_ruitu))


        print(tabulate([['90001', station_score['90001']['rmse'], station_score['90001']['t2m_rmse'], station_score['90001']['rh2m_rmse'], station_score['90001']['w10m_rmse']],\
        ['90002', station_score['90002']['rmse'], station_score['90002']['t2m_rmse'], station_score['90002']['rh2m_rmse'], station_score['90002']['w10m_rmse']],\
        ['90003', station_score['90003']['rmse'], station_score['90003']['t2m_rmse'], station_score['90003']['rh2m_rmse'], station_score['90003']['w10m_rmse']],\
        ['90004', station_score['90004']['rmse'], station_score['90004']['t2m_rmse'], station_score['90004']['rh2m_rmse'], station_score['90004']['w10m_rmse']],\
        ['90005', station_score['90005']['rmse'], station_score['90005']['t2m_rmse'], station_score['90005']['rh2m_rmse'], station_score['90005']['w10m_rmse']],\
        ['90006', station_score['90006']['rmse'], station_score['90006']['t2m_rmse'], station_score['90006']['rh2m_rmse'], station_score['90006']['w10m_rmse']],\
        ['90007', station_score['90007']['rmse'], station_score['90007']['t2m_rmse'], station_score['90007']['rh2m_rmse'], station_score['90007']['w10m_rmse']],\
        ['90008', station_score['90008']['rmse'], station_score['90008']['t2m_rmse'], station_score['90008']['rh2m_rmse'], station_score['90008']['w10m_rmse']],\
        ['90009', station_score['90009']['rmse'], station_score['90009']['t2m_rmse'], station_score['90009']['rh2m_rmse'], station_score['90009']['w10m_rmse']],\
        ['90010', station_score['90010']['rmse'], station_score['90010']['t2m_rmse'], station_score['90010']['rh2m_rmse'], station_score['90010']['w10m_rmse']],\
        ['all', station_score['all']['rmse'], station_score['all']['t2m_rmse'], station_score['all']['rh2m_rmse'], station_score['all']['w10m_rmse']]],\
        headers=['StationID', 'rmse', 't2m_rmse', 'rh2m_rmse', 'w10m_rmse']))
